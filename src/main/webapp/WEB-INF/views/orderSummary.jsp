...
<div class = "row">
  ...
  <div class="row">
	 ...
	 <thead>
			...
			<th></th>
			<th></th>
			<th class="text-center"><font color="white">Expected Delivery</font></th>
			<th class="text-center"><font color="white">Quantity</font></th>
		...
		<tbody>
			...
			<h4 class="media-heading"><a href="">${product.productName}</a></h4>
                                ...
                                <span> <font color="white">Status:</font> </span><span class="text-success"><strong><font color="white">In Stock</font></strong></span>
                            </div>
                        </div></td>
                 </c:if>
              </c:forEach>
            ...
            <font color="white"> With in 7 working days</font>
 			 </td>
			 <td class="col-sm-1 col-md-1" style="text-align: center">
			
			 <font color="white">${cart.productQuantity}</font>
