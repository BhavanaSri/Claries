...
<tr>
		...
		<br>
			...
			<tr>
			<td><font color="white">Supplier Name</font></td>
			<!-- <td><input type="text" name="supName"/></td> -->
			<td><form:input path="supName"/></td>
		</tr>
	
		<tr>
			<td><font color="white">Supplier Desc</font></td>
		...
		<tr bgcolor="pink">
			...
			<!-- <a href="<c:url value="deleteSupplier/${supplier.supId}"/>">DELETE</a>
				<a href="<c:url value="updateSupplier/${supplier.supId}"/>">UPDATE</a> -->	
						 ...
						 <a href="<c:url value="deleteSupplier/${supplier.supId}"/>" class="btn btn-primary a-btn-slide-text">
       <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
        <span><strong>DELETE</strong></span>            
    </a>
    
    
						 <a href="<c:url value="updateSupplier/${supplier.supId}"/>" class="btn btn-primary a-btn-slide-text">
